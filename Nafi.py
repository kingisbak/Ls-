...
def update():
    ...
    if (toolVersion != mainVersion):
        ...
        os.system("cd .. && cd Hacking boy l && python Hacker.py")
...
def logo():
    ...
    print("\033[94m│ \033[95mAuthor : Hacking boy.                \033[94m│".center(columns+15))
    print("│ \033[95mTool   : Unlimited SMS Bomber          \033[94m│".center(columns+9))
    print("│ \033[95mGitHub : https://github.com/hackingboyjr999@gmail.com \033[94m│".center(columns+9))
